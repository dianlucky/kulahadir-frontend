...
export const NotFoundLayout: React.FC = () => {
  ...
  return (
    <main className="flex items-center justify-center flex-col text-center h-screen pb-24 bg-brown">
      ...
      <div className="text-white">
        ...
        <Button variant="white" color="brown" radius="xl" size="xs" onClick={() => navigate(-1)}>
